  ...
  <div id="app">
    <div class="main-wrapper container">
      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        <a href="<?php echo base_url(); ?>" class="navbar-brand sidebar-gone-hide">DEA BAKERY</a>        
        ...
        <div class="nav-collapse">
          ...
          <!-- Akses Ujian Intelegensi -->
          <?php foreach($status as $data){ 
            if($data->INTELEGENSI == "Belum"){ ?>
            <li class="nav-item active"><a href="<?php echo base_url("index.php/ujian/intelegensi"); ?>" class="nav-link">Tes Intelegensi</a></li>            
            <?php
                } else {
            ...
            <!-- Akses Ujian Minat Bakat -->
            <?php foreach($status as $data){ 
            if($data->INTELEGENSI == "Belum"){ ?>
            <li class="nav-item"><a href="<?php echo base_url('index.php/Ujian/kraeplin') ?>" class="nav-link">Tes Kraeplin</a></li>            
            <?php
                } else {
            ...
            <li class="nav-item"><a href="<?php echo base_url('index.php/ujian/personality'); ?>" class="nav-link">Tes Personality</a></li>
        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            <img alt="image" src="<?php echo base_url('/assets/img/avatar/avatar.gif'); ?>" class="rounded-circle mr-1">
            <div class="d-sm-none d-lg-inline-block">Hi, <?php echo $this->session->nama; ?></div></a>
            <div class="dropdown-menu dropdown-menu-right">
              <div class="dropdown-title">Logged in 5 min ago</div>
              <a href="<?php echo base_url('index.php/settings/profile'); ?>" class="dropdown-item has-icon">
